...
import com.github.niuhf0452.exile.inject.scope.SingletonScope
...
object Qualifiers {
    ...
    fun named(value: String): Named = Qualifiers.qualifier(Named::class, value)

    fun singleton(): Singleton = Qualifiers.qualifier(Singleton::class)
}
...
interface Scope<A : Annotation> {
    fun getContainer(): Scope.Container<A>
