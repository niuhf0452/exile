...
object Bom {
    ...
    const val `kotlinx-coroutines-core-common` = "org.jetbrains.kotlinx:kotlinx-coroutines-core-common:${Vers.kotlinx_coroutines}"
    ...
    const val `log4j-core` = "org.apache.logging.log4j:log4j-core:${Vers.log4j}"
